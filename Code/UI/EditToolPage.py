...
class EditToolPage(tk.Frame):
    ...
    def __initUI(self):
        ...
        self.ownerTxt.grid(row=0, column=4, padx=5, sticky="E")
        ...
        self.titleTxt.grid(row=1, column=4, padx=5, sticky="E")
        ...
        self.descriptionTxt.grid(row=2, column=4, padx=5, columnspan=4, sticky="E")
        ...
        self.conditionTxt.grid(row=3, column=4, padx=5, sticky="E")
        ...
        self.priceFullDayTxt.grid(row=4, column=4, padx=5, pady=5, sticky="E")
        ...
        self.priceHalfDayTxt.grid(row=5, column=4, padx=5, pady=5, sticky="E")
        ...
        self.dispatchTxt.grid(row=6, column=4, padx=5, pady=20, sticky="E")
