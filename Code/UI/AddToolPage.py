...
class AddToolPage(tk.Frame):
    ...
    def __initUI(self):
        ...
        imgPath = tk.Label(frame, text=strings.emptyIMGPath, bg=self.__bgColor, fg=self.__fgColor)
        imgPath.grid(row=6, column=1, padx=5, pady=2, sticky="W")
        ...
        img_btn.bind("<Button-1>", lambda event: self.__addTool.setImgPath(imgPath))
